...
$month = substr($postdate,5,2);
          ...
          $zonawaktujakarta = tampilkanconverzonawaktu($postdate);
					...
					if ( ($checkattachment=="jpg" || $checkattachment=="png") && $thumbnail!="") {
						$displayimage = "<a href='".$fileattachment."' target='_new'><img src='".$thumbnail."'></a>";
						$displayimage = $displayimage. "<br><a href='".$fileattachment."' target='_new'>Click here top open original images</a> ";
						...
						$dropbox_save = $dropbox_save. "<a href='https://db.tt/nGZfRdiC' target='_new'><img width='20' height='20' src='icon-dropbox.jpg'><small>Create Account at DropBox</small></a>";
					    if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
							$dropbox_save="";
							$displayimage ="";
							$displayimage = "<img src='icon-jpg.jpg'  width='60' height='80'>".
					...
					if ($checkattachment=="gif" && $thumbnail=="") {
							$displayimage = "<img src='".$fileattachment."'>";
 					    $dropbox_save = "<script type='text/javascript' src='https://www.dropbox.com/static/api/2/dropins.js' id='dropboxjs' data-app-key='k98k2vmr46h14q4'></script>";
						$dropbox_save = $dropbox_save. "<p>&nbsp;</p><a href='http://".$host."/".$fileattachment."' class='dropbox-saver'></a>";
						$dropbox_save = $dropbox_save. "<a href='https://db.tt/nGZfRdiC' target='_new'><img width='20' height='20' src='icon-dropbox.jpg'><small>Create Account at DropBox</small></a>";
						if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
							$dropbox_save="";
							$displayimage ="";
							$displayimage = "<img src='icon-gif.jpg'  width='60' height='80'>".
					...
					if ($checkattachment=="swf") {
						$displayimage = "";
						$displayimage = "<a target='_new' href='".$fileattachment."'><img src='icon-swf.jpg'  width='60' height='80'></a>";
						$displayimage = $displayimage. "<p><a target='_new' href='".$fileattachment."'>Download document SWF file here</a>";
						$dropbox_save = "<script type='text/javascript' src='https://www.dropbox.com/static/api/2/dropins.js' id='dropboxjs' data-app-key='k98k2vmr46h14q4'></script>";
						$dropbox_save = $dropbox_save. "<p>&nbsp;</p><a href='http://".$host."/".$fileattachment."' class='dropbox-saver'></a>";
						$dropbox_save = $dropbox_save. "<a href='https://db.tt/nGZfRdiC' target='_new'><img width='20' height='20' src='icon-dropbox.jpg'><small>Create Account at DropBox</small></a>";
						if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
							   $dropbox_save="";
								$displayimage ="";
								$displayimage = "<img src='icon-swf.jpg'  width='60' height='80'>".
					...
					if ($checkattachment=="ppt") {
							$displayimage = "<a target='_new' href='".$fileattachment."'><img src='icon-ppt.jpg'  width='60' height='80'></a>";
							...
							if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
								$dropbox_save="";
								$displayimage ="";
								$displayimage = "<img src='icon-ppt.jpg'  width='60' height='80'>".
					...
					if ($checkattachment=="txt") {
							$displayimage = "<a target='_new' href='".$fileattachment."'><img src='icon-txt.png'  width='60' height='80'></a>";
							$displayimage=$displayimage. "<p><a target='_new' href='".$fileattachment."'>Download document TXT file here</a>";
							//$displayimage=$displayimage. "<p>Variabel bolehbukafile = ".$bolehbukafile;
						$dropbox_save = "<script type='text/javascript' src='https://www.dropbox.com/static/api/2/dropins.js' id='dropboxjs' data-app-key='k98k2vmr46h14q4'></script>";
						$dropbox_save = $dropbox_save. "<p>&nbsp;</p><a href='http://".$host."/".$fileattachment."' class='dropbox-saver'></a>";
						$dropbox_save = $dropbox_save. "<a href='https://db.tt/nGZfRdiC' target='_new'><img width='20' height='20' src='icon-dropbox.jpg'><small>Create Account at DropBox</small></a>";
						if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
								$dropbox_save="";
								$displayimage ="";
								$displayimage = "<img src='icon-txt.png'  width='60' height='80'>".
					...
					if ($checkattachment=="pdf") {
							$displayimage = "<a target='_new' href='".$fileattachment."'><img src='images-pdf-document.jpg'  width='60' height='80'></a>";
							$displayimage=$displayimage. "<p><a target='_new' href='".$fileattachment."'>Download document PDF file here</a>";
							//$displayimage=$displayimage. "<p>Variabel bolehbukafile = ".$bolehbukafile;
							$dropbox_save = "<script type='text/javascript' src='https://www.dropbox.com/static/api/2/dropins.js' id='dropboxjs' data-app-key='k98k2vmr46h14q4'></script>";
							$dropbox_save = $dropbox_save. "<p>&nbsp;</p><a href='http://".$host."/".$fileattachment."' class='dropbox-saver'></a>";
							$dropbox_save = $dropbox_save. "<a href='https://db.tt/nGZfRdiC' target='_new'><img width='20' height='20' src='icon-dropbox.jpg'><small>Create Account at DropBox</small></a>";
							if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
								$dropbox_save="";
								$displayimage ="";
								$displayimage = "<img src='images-pdf-document.jpg'  width='60' height='80'>".
					...
					if ($checkattachment=="xls") {
							$displayimage = "<a target='_new' href='".$fileattachment."'><img src='images-xls-document.jpg' width='70' height='100' ></a>";
							$displayimage=$displayimage. "<p><a target='_new' href='".$fileattachment."'>Download document XLS file here</a>";
							$dropbox_save = "<script type='text/javascript' src='https://www.dropbox.com/static/api/2/dropins.js' id='dropboxjs' data-app-key='k98k2vmr46h14q4'></script>";
							$dropbox_save = $dropbox_save. "<p>&nbsp;</p><a href='http://".$host."/".$fileattachment."' class='dropbox-saver'></a>";
							$dropbox_save = $dropbox_save. "<a href='https://db.tt/nGZfRdiC' target='_new'><img width='20' height='20' src='icon-dropbox.jpg'><small>Create Account at DropBox</small></a>";
							if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
								$dropbox_save="";
								$displayimage ="";
								$displayimage = "<img src='images-xls-document.jpg'  width='60' height='80'>".
					...
					if ($checkattachment=="zip") {
							$displayimage = "<a target='_new' href='".$fileattachment."'><img src='icon-zip.png'  width='60' height='80'></a>";
							$displayimage=$displayimage. "<p><a target='_new' href='".$fileattachment."'>Download document ZIP file here</a>";
							$dropbox_save = "<script type='text/javascript' src='https://www.dropbox.com/static/api/2/dropins.js' id='dropboxjs' data-app-key='k98k2vmr46h14q4'></script>";
	   						$dropbox_save = $dropbox_save. "<p>&nbsp;</p><a href='http://".$host."/".$fileattachment."' class='dropbox-saver'></a>";
							$dropbox_save = $dropbox_save. "<a href='https://db.tt/nGZfRdiC' target='_new'><img width='20' height='20' src='icon-dropbox.jpg'><small>Create Account at DropBox</small></a>";
							if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
								$dropbox_save="";
								$displayimage ="";
								$displayimage = "<img src='icon-zip.png'  width='60' height='80'>".
					...
					if ($checkattachment=="doc") {
							...
							if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
								$dropbox_save="";
								$displayimage ="";
								$displayimage = "<img src='images-doc-document.jpg'  width='60' height='80'>".
					...
					if ($checkattachment=="mp4" || $checkattachment=="mp3") {
						...
						$displayimage=$displayimage. "<source src=\"$fileattachment\" type=\"$typeplayer\">";
						$displayimage=$displayimage. "Your browser does not support the video tag";
						$displayimage=$displayimage. "</video>";
						$displayimage=$displayimage. "<p><br><a target='_new' href='$fileattachment'>Download this audio/video here</a></p>";
						$dropbox_save = "<script type='text/javascript' src='https://www.dropbox.com/static/api/2/dropins.js' id='dropboxjs' data-app-key='k98k2vmr46h14q4'></script>";
						$dropbox_save = $dropbox_save. "<p>&nbsp;</p><a href='http://".$host."/".$fileattachment."' class='dropbox-saver'></a>";
					$dropbox_save = $dropbox_save. "<a href='https://db.tt/nGZfRdiC' target='_new'><img width='20' height='20' src='icon-dropbox.jpg'><small>Create Account at DropBox</small></a>";
						if (($passprotected!="" && $mode !="revealfile") || ($passprotected!="" && $bolehbukafile==0)) {
							   $dropbox_save="";
								$displayimage ="";
								$displayimage = "<img src='icon-audiovideo.jpg'  width='60' height='80'>".
		...
		<a name="msgid<? echo $msgid ?>"></a>					
			<div class="panel panel-info">
						...
						<h2 class="panel-title"><?php echo $contentmsg ?></h2>
						</div>
					...
					if ($displayimage!="") {
						...
						<br><small>Pos : <input type="text" value="<? echo $lat_shout ?>,<? echo $lon_shout ?>"></small>
					<br><small>MessagesID:<?php echo $msgid ?></small>
					<br><small>posted on <?php echo $zonawaktujakarta ?> (Based on GMT +7)</small>
					<br><small><?php echo $keteranganwaktu ?></small>
					<br><small><a href="#menu">Back To Menu</a></small>
					<p>
					<?php
					include("comment.php");
					?>
